...
class SubjectSeeder extends Seeder
{
    public function run()
    {
        $subjects = [
            LevelName::FirstYear->value => [
                ...
                SemesterName::SecondSemester->value => [
                    ...
                    ['code' => 'CST-1212', 'name' => 'Programming Logic & Design (C++)'],
            ...
            LevelName::SecondYear->value => [
                ...
                SemesterName::SecondSemester->value => [
                    ...
                    ['code' => 'CS-2254', 'name' => 'Web Development (JavaScript)'],
            ...
            LevelName::FourthYear->value => [
                ...
                SemesterName::SecondSemester->value => [
                    ...
                    ['code' => 'CST-4242', 'name' => 'Modeling & Simulation'],
        ...
        foreach ($createdSubjects as $subject) {
            if ($teachers->count() > 0) {
                $assignedTeachers = $teachers->random(rand(1, min(3, $teachers->count())));
