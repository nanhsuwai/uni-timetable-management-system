...
const submit = () => {
  form.post(route("teacher.register"), {
    ...
    toast.add({
        type: "success",
        message: "Your teacher application has been submitted successfully. You will be notified once it is reviewed by an administrator.",
      });
        ...
        <div class="min-h-screen flex items-center justify-center py-4 sm:py-6 lg:py-12 px-3 sm:px-4 lg:px-8">
            <div class="w-full max-w-sm sm:max-w-md lg:max-w-lg space-y-6 sm:space-y-8">
                ...
                <div class="text-center" :class="{
                    ...
                    <p class="text-sm sm:text-base text-gray-600">Apply to join University of Computer Studies, Hinthada</p>
                    <p class="text-xs sm:text-sm text-teal-600 mt-1">Timetable Management System</p>
                    <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <p class="text-sm text-yellow-800">
                            <strong>Note:</strong> Your application will be reviewed by an administrator before approval.
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    <!-- Name Field -->
                    <FormField label="Full Name" label-for="name" help="Enter your full name as it appears on official documents">
                        <FormControl
                            v-model="form.name"
                            id="name"
                            :icon="mdiAccount"
                    ...
                    <!-- Email Field -->
                    <FormField label="Email Address" label-for="email" help="We'll send you important updates about your application">
                        <FormControl
                            v-model="form.email"
                            id="email"
                            :icon="mdiEmail"
                    ...
                    <BaseButtons class="flex-col sm:flex-row gap-2 sm:gap-3">
                        ...
                        >
                            <svg v-if="form.processing" class="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 animate-spin" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                            </svg>
                            ...
                            <span class="hidden sm:inline">{{ form.processing ? 'Submitting Application...' : 'Submit Application' }}</span>
