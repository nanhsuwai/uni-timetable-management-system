        ...
        <div class="w-full max-w-md">
          <div class="bg-white/90 dark:bg-gray-800/80 backdrop-blur-lg shadow-xl rounded-lg p-6">
            ...
            <form @submit.prevent="submit">
              ...
              <div v-if="status" class="mb-4 p-3 bg-green-100 border border-green-400 text-green-700 rounded-md">
                {{ status }}
              </div>
              ...
              <div class="mt-4 text-center">
                <a @click="$inertia.visit('/login')"
                  class="text-blue-600 cursor-pointer hover:text-blue-800 text-sm font-medium transition-all duration-300 hover:bg-blue-50 px-3 py-2 rounded-md transform hover:scale-105">
                  ← Back to Login
              </a>
