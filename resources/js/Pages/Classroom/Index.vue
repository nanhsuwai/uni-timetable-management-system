...
<template>
  <LayoutAuthenticated>
    ...
    <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <div class="flex justify-between items-start mb-4">
            <h2
              class="text-2xl font-bold text-gray-800 dark:text-gray-100 tracking-wide"
            >
              {{ classroom.room_no }}
            </h2>
          ...
          <div class="mb-5 border-t pt-4 dark:border-gray-700">
            ...
            >
              {{
                classroom.section
                  ? `${classroom.section.academic_level.name} - ${classroom.section.name} (${classroom.section.academic_level.academic_program.name})`
                  : 'Unassigned'
              }}
            </p>
          </div>
      ...
      <div v-if="props.classrooms.data.length === 0" class="text-center py-10 text-gray-500 dark:text-gray-400 italic text-lg">
      ...
      <Modal :show="confirmingClassroom" @close="closeModal">
        <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
          <h2
            class="text-xl font-semibold mb-4 border-b pb-3 text-gray-900 dark:text-gray-100 dark:border-gray-700"
          >
            {{ editingClassroom ? 'Edit Classroom' : 'Add Classroom' }}
          </h2>
          <InputLabel
              for="room_no"
              value="Room Number / Name"
