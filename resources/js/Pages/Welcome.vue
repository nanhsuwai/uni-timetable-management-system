        ...
        <div class="relative z-40 max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-6 sm:py-8 lg:py-12">
                            ...
                            <div class="mb-6 lg:mb-8 justify-items-center">
                                ...
                                <div class="lg:pl-4 xl:pl-8 order-1 lg:order-2" :class="{
                                    ...
                                    <div
                                        ...
                                        <button @click="switchToTimetable" class="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 lg:px-8 py-2 sm:py-3 border border-transparent
           text-xs sm:text-sm lg:text-base font-medium rounded-xl text-white
         ...
         00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
           ...
           shadow-md hover:shadow-lg backdrop-blur-md">
                                        ...
                                        <button @click="switchToLogin" class="w-full sm:w-auto inline-flex items-center justify-center px-4 sm:px-6 lg:px-8 py-2 sm:py-3
           border border-teal-600 text-xs sm:text-sm lg:text-base font-medium
           ...
           shadow-md hover:shadow-lg backdrop-blur-md">
                ...
                <div v-else-if="activeTab === 'teacher-register'">
                    <div class="mb-4 text-center">
