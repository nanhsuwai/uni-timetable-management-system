...
<template>
  <LayoutAuthenticated>
    ...
    <div class="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      >
        <h1
          class="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-wide"
        >
          Curriculum Subjects
        </h1>
        <PrimaryButton
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm text-center table-auto border-collapse">
            ...
            >
              <tr>
                <th
                  class="px-4 py-3 w-12 border-b dark:border-gray-600 font-bold"
                >
                  #
                </th>
                <th
                  class="px-4 py-3 border-b dark:border-gray-600 text-left font-bold"
                >
                  Code
                </th>
                <th
                ...
                <th
                  class="px-4 py-3 w-56 border-b dark:border-gray-600 font-bold"
                >
                  Actions
                </th>
              </tr>
      ...
      <Modal :show="confirmingSubjectCreation" @close="closeModal">
        <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
          <h2
            class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6 border-b pb-3 dark:border-gray-700"
          >
          ...
          <form @submit.prevent="createOrUpdateSubject" class="space-y-4">
            ...
            <div
              class="mt-6 flex justify-end space-x-3 pt-4 border-t dark:border-gray-700"
            >
