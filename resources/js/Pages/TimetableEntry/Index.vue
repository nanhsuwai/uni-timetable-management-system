    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-white p-4 rounded-lg shadow">
        <div>
          ...
          <select v-model="filterYear" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div>
          ...
          <select v-model="filterSemester" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div>
          ...
          <select v-model="filterProgram" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div>
          ...
          <select v-model="filterDay" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <tr v-for="(entry, index) in props.entries.data" :key="entry.id" class="hover:bg-gray-50 transition">
              ...
              <td class="px-4 py-2 border-b">
                <div v-if="entry.teachers && entry.teachers.length > 0" class="flex flex-wrap gap-1">
                  <span v-for="teacher in entry.teachers" :key="teacher.id" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                    {{ teacher.name }}
                  </span>
                </div>
              ...
              <td class="px-4 py-2 border-b">
                <span v-if="entry.subject_id && entry.teachers && entry.teachers.length > 0" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                  ✓ {{ entry.teachers.length }} teacher{{ entry.teachers.length > 1 ? 's' : '' }} assigned
                </span>
                <span v-else-if="entry.subject_id && (!entry.teachers || entry.teachers.length === 0)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                  ⚠ No teachers assigned
                </span>
                <span v-else class="text-gray-400 text-xs">N/A</span>
              </td>
              <td class="px-4 py-2 border-b">{{ getDayName(entry.day_of_week) }}</td>
              <td class="px-4 py-2 border-b">{{ entry.time_slot?.name || 'N/A' }} ({{ entry.start_time }} - {{ entry.end_time }})</td>
              <td class="px-4 py-2 border-b space-x-2">
                <button @click.prevent="showEditModal(entry)" class="px-3 py-1 rounded-md bg-blue-500 text-white text-xs hover:bg-blue-600">
                  Edit
                </button>
                <button @click.prevent="showDeleteEntryModal(entry)" class="px-3 py-1 rounded-md bg-red-500 text-white text-xs hover:bg-red-600">
                  Delete
                </button>
              </td>
            </tr>
      ...
      <Modal :show="confirmingEntryCreation" @close="closeModal">
        <div class="p-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <InputLabel value="Academic Year" />
              <select v-model="selectedYear" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              <InputLabel value="Academic Program" />
              <select v-model="selectedProgram" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500" :disabled="filteredPrograms.length === 0 && selectedYear">
            ...
            <div>
              ...
              <select v-model="selectedLevel" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              ...
              <select v-model="selectedSection" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              ...
              <select v-model="form.classroom_id" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              <InputLabel value="Semester" />
              <select v-model="form.semester_id" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              ...
              <select v-model="form.subject_id" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              ...
              <div v-if="filteredTeachers.length === 0 && form.subject_id" class="w-full border border-gray-300 rounded-md shadow-sm p-3 bg-gray-50">
                <p class="text-sm text-gray-500">
                  No teachers are assigned to teach this subject yet.
                  <button @click="navigateToSubjectTeacherManagement" class="text-blue-600 hover:text-blue-800 underline ml-1">
                    Assign Teachers to Subjects
                  </button>
                </p>
              </div>
              <div v-else-if="filteredTeachers.length > 0" class="w-full border border-gray-300 rounded-md shadow-sm p-3 max-h-40 overflow-y-auto">
            ...
            <div>
              ...
              <select v-model="form.day_of_week" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
              ...
              <select v-model="form.time_slot_id" class="w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
      ...
      <Modal :show="showDeleteModal" @close="closeDeleteModal">
        <div class="p-6">
          ...
          <p class="text-sm text-gray-600">Are you sure you want to delete this timetable entry? This action cannot be undone.</p>
          <div class="mt-6 flex justify-end space-x-2">
