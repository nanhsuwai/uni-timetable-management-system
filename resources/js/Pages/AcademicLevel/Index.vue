...
<template>
  <LayoutAuthenticated>
      ...
      <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
          ...
          <PrimaryButton @click="openCreateModal"
            class="text-cyan-500 bg-cyan-500 dark:bg-white dark:text-cyan-500 shadow-lg hover:shadow-xl hover:bg-cyan-600 dark:hover:shadow-xl dark:hover:bg-white transition-all duration-300 transform hover:scale-[1.02]">
        ...
        <div
          ...
          <div>
            <InputLabel for="filterName" value="Filter by Name" class="dark:text-gray-300" />
            <TextInput id="filterName" v-model="filterName" type="text" placeholder="Search levels..."
          ...
          <div>
            <InputLabel for="filterProgram" value="Filter by Program" class="dark:text-gray-300" />
        ...
        <div
          ...
          <table class="min-w-full text-sm text-center">
            ...
            <tbody>
              <tr v-for="(level, index) in props.levels.data" :key="level.id"
              ...
              <tr v-if="props.levels.data.length === 0">
                <td colspan="4" class="py-8 text-gray-500 dark:text-gray-400 italic text-base">
        ...
        <Modal :show="confirmingModal" @close="closeModal">
          <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <form @submit.prevent="saveLevel" class="space-y-5">
              <div>
                <InputLabel for="academic_year_id" value="Academic Year" class="dark:text-gray-300" />
              ...
              <div>
                <InputLabel for="program_id" value="Academic Program" class="dark:text-gray-300" />
              ...
              <div>
                <InputLabel for="name" value="Level Name" class="dark:text-gray-300" />
    ...
    focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-indigo-500 dark:focus:border-indigo-400">
          ...
          <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <div class="mt-6 flex justify-end space-x-3">
              ...
              <PrimaryButton
                ...
                :disabled="form.processing" @click.prevent="deleteLevel">
                Delete
              </PrimaryButton>
            </div>
          </div>
        ...
        <Modal :show="showingSectionFormModal" @close="closeEditSectionModal" class="z-20">
          <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 border-b pb-3 mb-4 dark:border-gray-700">
            ...
            <form @submit.prevent="saveSection" class="space-y-5">
              <div>
                <InputLabel for="section_name" value="Section Name" class="dark:text-gray-300" />
                <TextInput id="section_name" v-model="sectionForm.name" type="text"
                  class="w-full transition duration-150 ease-in-out border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 rounded-lg shadow-sm"
                  placeholder="Enter Section name (A or B)" />
                <InputError :message="sectionForm.errors.name" />
              </div>
              <div>
                <InputLabel for="classroom_id" value="Classroom" class="dark:text-gray-300" />
              ...
              <div>
                <InputLabel for="section_head_teacher_id" value="Section Head Teacher" class="dark:text-gray-300" />
        ...
        <Modal :show="!!deletingSection" @close="() => (deletingSection = null)">
          <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
            ...
            <div class="mt-6 flex justify-end space-x-3">
              ...
              <PrimaryButton
                class="bg-red-600 hover:bg-red-700 focus:ring-red-500 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-400"
                :disabled="sectionForm.processing" @click.prevent="deleteSection">
                Delete
              </PrimaryButton>
            </div>
          </div>
